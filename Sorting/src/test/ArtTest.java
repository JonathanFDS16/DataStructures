...
class ArtTest {
    ...
    public void compareToWidths() {
        ...
        Art art3 = new Art(1, 10, 4, "Adam", "Michelangelo");
    ...
    public void compareToNames() {
        Art art1 = new Art(10, 4, 2, "Mona lisa", "DaVince");
        Art art2 = new Art(10, 4, 2, "Zebra", "DaVince");
        Art art3 = new Art(10, 4, 2, "Chapel", "John Doe");
    ...
    public void compareToArtistNames() {
        ...
        Art art3 = new Art(10, 4, 2, "Three Two One", "John Doe");
